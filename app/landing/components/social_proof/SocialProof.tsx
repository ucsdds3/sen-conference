  ...
  return (
    <section className="bg-white ~px-6/16" style={{ height: "100svh" }}>
      ...
      <div className="flex flex-col justify-center items-center gap-6 h-full md:hidden py-12 px-6">
        <h2 className="font-black tracking-tighter text-[#0D1626] text-center text-5xl leading-none">
          500+ students engaged
        </h2>
        {quotes.map((q, i) => (
          <p key={i} className="text-center text-sm font-light text-[#0D1626]/70 leading-snug max-w-sm">
            &ldquo;{q.text}&rdquo;
          </p>
        ))}
      </div>
